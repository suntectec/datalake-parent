package com.suntectec.realtime.ods.source;
...
public class SqlserverOdsSource {
    ...
    public static Properties getDebeziumProperties() {
        ...
        properties.put("sqlserverDebeziumConverter.type", "com.suntectec.realtime.ods.converter.DateTimeDebeziumConverter");
