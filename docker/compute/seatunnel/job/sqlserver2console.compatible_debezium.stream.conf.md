...
```
curl --location 'http://192.168.138.15:8080/submit-job/upload' --form 'config_file=@"/opt/poc-allin1/docker/compute/seatunnel/job/sqlserver2console.compatible_debezium.stream.conf"'
```
