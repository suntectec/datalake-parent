 ...
 */
public class CdcIngestionRichCdcRecord2PaimonS3Job {

    // Define Logger at the class level
    private static final Logger logger = LoggerFactory.getLogger(CdcIngestionRichCdcRecord2PaimonS3Job.class);
