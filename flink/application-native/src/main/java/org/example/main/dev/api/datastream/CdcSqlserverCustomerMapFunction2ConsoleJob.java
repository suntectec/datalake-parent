...
import org.example.function.CustomerDebeziumMapFunction;
 ...
 */
public class CdcSqlserverCustomerMapFunction2ConsoleJob {

    // Define Logger at the class level
    private static final Logger logger = LoggerFactory.getLogger(CdcSqlserverCustomerMapFunction2ConsoleJob.class);
    ...
    public static void run(String sqlserver_host, String sqlserver_port, String sqlserver_username, String sqlserver_password,
        ...
        sourceDS
                .setParallelism(2)
                .map(new CustomerDebeziumMapFunction())
                .print()
                .setParallelism(1);
    ...
    public static void main(String[] args) throws Exception {
        ...
        CdcSqlserverCustomerMapFunction2ConsoleJob.run(sqlserver_host, sqlserver_port, sqlserver_username, sqlserver_password,
