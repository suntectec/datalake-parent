 ...
 */
public class SQLSqlserverOrders2PaimonOrdersJob {
    private static final Logger logger= LoggerFactory.getLogger(SQLSqlserverOrders2PaimonOrdersJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        SQLSqlserverOrders2PaimonOrdersJob.run(sqlserver_host, sqlserver_port, sqlserver_username, sqlserver_password,
