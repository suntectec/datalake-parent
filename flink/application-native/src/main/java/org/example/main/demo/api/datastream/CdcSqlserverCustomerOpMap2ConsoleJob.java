...
import org.example.function.CustomerDebezium2TableMapFunction;
 ...
 */
public class CdcSqlserverCustomerOpMap2ConsoleJob {

    // Define Logger at the class level
    private static final Logger logger = LoggerFactory.getLogger(CdcSqlserverCustomerOpMap2ConsoleJob.class);
    ...
    public static void run(String sqlserver_host, String sqlserver_port, String sqlserver_username, String sqlserver_password,
        ...
        sourceDS
                .setParallelism(2)
                .map(new CustomerDebezium2TableMapFunction())
                .print()
                .setParallelism(1);
    ...
    public static void main(String[] args) throws Exception {
        ...
        CdcSqlserverCustomerOpMap2ConsoleJob.run(sqlserver_host, sqlserver_port, sqlserver_username, sqlserver_password,
