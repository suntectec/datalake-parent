 ...
 */
public class CdcSqlserver2KafkaJob {
    private static final Logger logger = LoggerFactory.getLogger(CdcSqlserver2KafkaJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String warehouse = CustomerParameter.getParameter("dev", "warehouse");
        ...
        CdcSqlserver2KafkaJob.run(sqlserver_host, sqlserver_port, sqlserver_username, sqlserver_password,
