package org.example.main.demo.api.table;
 ...
 */
public class JdbcSqlserver2MysqlJob {
    private static final Logger logger = LoggerFactory.getLogger(JdbcSqlserver2MysqlJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        JdbcSqlserver2MysqlJob.run(sqlserver_host, sqlserver_port, sqlserver_username, sqlserver_password,
