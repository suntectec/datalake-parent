package org.example.main.application;
 ...
 */
public class DataStreamSqlServerOrders2PaimonOrdersJob {

    // Define Logger at the class level
    private static final Logger logger = LoggerFactory.getLogger(DataStreamSqlServerOrders2PaimonOrdersJob.class);
