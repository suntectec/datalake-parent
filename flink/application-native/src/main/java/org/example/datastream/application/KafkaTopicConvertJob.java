 ...
 */
public class KafkaTopicConvertJob {
    public static final Logger loggger = LoggerFactory.getLogger(KafkaTopicConvertJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaTopicConvertJob.run(kafka_brokers);
    }
}
