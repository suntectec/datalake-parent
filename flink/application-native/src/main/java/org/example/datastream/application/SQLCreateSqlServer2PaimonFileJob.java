 ...
 */
public class SQLCreateSqlServer2PaimonFileJob {

    // Define Logger at the class level
    private static final Logger logger = LoggerFactory.getLogger(SQLCreateSqlServer2PaimonFileJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        SQLCreateSqlServer2PaimonFileJob.run(mySqlServerHost, mySqlServerPort, mySqlServerUsername, mySqlServerPassword);
